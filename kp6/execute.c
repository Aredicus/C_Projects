...
void print_menu() {
    ...
    printf("|  exit  | выход                                                                                      |\n");
    printf("|-----------------------------------------------------------------------------------------------------|\n");
    printf("|  info  | информация о конкретном студенте (info [Фамилия] [Инициалы])                               |\n");
    printf("|-----------------------------------------------------------------------------------------------------|\n");
    printf("|  add   | добавление студента (add [Фамилия] [Инициалы] [Пол] [Номер класса] [Буква] [Номер школы])  |\n");
    printf("|-----------------------------------------------------------------------------------------------------|\n");
    printf("|  task  | сравнить количество студентов в классе  с студентами 10 класса (task [Класс])              |\n");
    printf("|-----------------------------------------------------------------------------------------------------|\n");
    printf("|  show  | распечатать таблицу                                                                        |\n");
    printf("|-----------------------------------------------------------------------------------------------------|\n");
    printf("| remove | удаление студента (remove [Фамилия] [Инициалы])                                            |\n");
    printf("|=====================================================================================================|\n");
}
...
int main(int argc, char *argv[]) {
    if (argc != 2) {
        printf("Вы должны запускать программу с базой данных студентов\n");
        exit(1);
    }
    ...
    while(strcmp(choose, "exit") != 0) {
        ...
        if (strcmp(cmd, "add") == 0) {
            ...
            if (arg[0] == '\0') {
                printf("Ошибка! Добавьте имя студента и инициалы\n");
                continue;
            }
            student* find = find_element(table, arg);
            if (find == NULL) {
                printf("Не удается найти студента: %s\n", arg);
                continue;
            }
            print_student(find);
